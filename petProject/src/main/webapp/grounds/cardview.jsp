...
<body>
	<%
		...
		ArrayList<GroundDTO> dto = dao.getSelect();
	...
	<div class="left-container">
		...
		<div class="map_container">
			<%@ include file="groundKakao.jsp" %>
		</div>		
	</div>
	
	<div class="card_container" >
		<a href="ground.jsp?shopNo=11" style="text-decoration: none">
		...
		<a href="ground.jsp?shopNo=12" style="text-decoration: none">
		<div class="card mb-5" style="width: 960px; height:220px;">
		  <div class="row no-gutters">
		    <div class="col-md-4">
		...
		<a href="ground.jsp?shopNo=13" style="text-decoration: none">
		<div class="card mb-5" style="width: 960px; height:220px;">
		  <div class="row no-gutters">
		    <div class="col-md-4">
		...
		<a href="ground.jsp?shopNo=14" style="text-decoration: none">
		...
		<a href="ground.jsp?shopNo=15" style="text-decoration: none">
		<div class="card mb-5" style="width: 960px; height:220px;">
		  <div class="row no-gutters">
		    <div class="col-md-4">
