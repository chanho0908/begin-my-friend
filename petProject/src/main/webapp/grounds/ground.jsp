...
<body>
	...
	<%
	    ...
	    int no = Integer.parseInt(shopNo);
	   	GroundDTO dto = new GroundDAO().getGround(no);
	    
	   	ArrayList<String> imgPath = new GroundDAO().getImgPath(no);
	...
	<script type="text/javascript">
		function addBookMark(){
    		location.href='../addBookmark2.jsp?shopNo=<%=no%>'
    	}
...
<div class="right_container">
	  <div class="info_container">
		...
		<div class="info-property">
			<span>
			<% if(shopNo.equals("11")){%>
				<%@ include file="../info/mungtInfo.jsp" %>	
			<%	
			}else if(shopNo.equals("12")){%>
				<%@ include file="../info/guriInfo.jsp" %>
			<%	
			}else if(shopNo.equals("13")){%>
				<%@ include file="../info/forestInfo.jsp" %>
			<%	
			}else if(shopNo.equals("14")){%>
				<%@ include file="../info/bisoupInfo.jsp" %>
			<%	
			}else if(shopNo.equals("15")){%>
				<%@ include file="../info/lucasInfo.jsp" %>
			<%	
			}
			%>
