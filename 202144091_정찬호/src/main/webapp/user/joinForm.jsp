...
<body>
	<div class="container">
		<div class="title">FOOTBALL GROUND</div>
		...
		<form method="post" name="userInfo" action="joinAction.jsp" onsubmit="return checkValue()">
            <table>
                <tbody>
                    ...
                    <td colspan="3">
                    	<input type="text" class="form-control" name="userID" maxlength="20" style="width:200px; height:35px; font-size:18px;">
                    </td>
                    ...
                    <tr>
                    	...
                    	<td colspan="3"><input type="text" class="form-control" name="userAge" maxlength="20" style="width:200px;height:35px;font-size:18px;"></td>
                    </tr>
                    <tr>
